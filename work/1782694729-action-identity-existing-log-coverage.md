...
- Logs scanned: 67
- Pre-clamp actor contexts: 27 (`resolved`=17, `ambiguous`=0, unresolved positive debit=0)
- Legacy self-hit/AoE actor-context hints: 2 (candidate cases for `resolved-self` retest).
- Pending matches: 329 (`resolved`=105)
- Immediate candidate snapshots: 160 (`selected`=70)
- Formula candidates: 166
- Selector probes: 6 (with actor refs=2)
...
| ---: | --- | ---: |
| 0 | Basic Attack / implicit weapon | 6 |
| 1 | Cure | 43 |
| 16 | Fire | 15 |
| 158 | Hallowed Bolt | 2 |
...
| Action id | Meaning | Count |
| ---: | --- | ---: |
| 0 | Basic Attack / implicit weapon | 8 |

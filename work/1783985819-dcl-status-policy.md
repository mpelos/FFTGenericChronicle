...
Source: `D:/Projects/FFTGenericChronicle/work/1783983869-dcl-ability-classification.csv` (`512` abilities).
Row manifest: `work/1783985819-dcl-status-policy.csv`.
...
| lifecycle-mechanism-required | 10 |
| native-lifecycle-preserved | 4 |
| surface-ready | 195 |
...
| Crystal | 1 | special-operation-review | lifecycle | explicit-rule | lifecycle-mechanism-required |
...
| Dead | 13 | add-harmful, remove-ko | lifecycle | explicit-rule, none | lifecycle-mechanism-required, native-lifecycle-preserved |
...
- `Dead`, `Undead`, and `Crystal` live in status byte 0. Generic `DclStatusRule` whitelists only proven-safe Undead `0x10`; offensive KO and Crystal remain dedicated lifecycle gates.

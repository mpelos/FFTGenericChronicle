...
Row manifest: `work/1783986363-dcl-status-policy.csv`.
...
| lifecycle-mechanism-required | 1 |
...
- `Dead`, `Undead`, and `Crystal` live in status byte 0. Generic `DclStatusRule` whitelists only proven-safe Undead `0x10`; offensive KO uses the dedicated lethal-debit route and Crystal remains a lifecycle gate.

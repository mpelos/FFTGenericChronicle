...
Row manifest: `work/1784009184-dcl-ability-classification-candidates.csv`.
...
| Readiness | Abilities |
| --- | ---: |
| authoring-required | 94 |
| data-authoring | 128 |
| data-or-authoring-required | 4 |
| formula-map-required | 96 |
| native-special-preserved | 1 |
...
| noncanonical_magic_or_hybrid_damage | 43 |
| passive | 88 |
| physical_ability_damage | 19 |
| physical_damage | 17 |
| physical_status | 13 |
...
| 0x14 | 1 | golem_pool | reverse-engineering | 65:Golem |
...
| 0x1C | 7 | song_or_dance | reverse-engineering | 86:Seraph Song; 87:Life's Anthem; 88:Rousing Melody; 89:Battle Chant |
| 0x1D | 7 | song_or_dance | reverse-engineering | 93:Witch Hunt; 94:Mincing Minuet; 95:Slow Dance; 96:Polka |
...
| 0x25 | 4 | equipment_break | authoring-required | 138:Rend Helm; 139:Rend Armor; 140:Rend Shield; 141:Rend Weapon |
| 0x26 | 10 | steal | reverse-engineering | 110:Steal Helm; 111:Steal Armor; 112:Steal Shield; 113:Steal Weapon |
| 0x27 | 3 | steal | reverse-engineering | 108:Steal Gil; 307:Glitterlust; 359:Plunder Gil |
| 0x28 | 2 | steal | reverse-engineering | 115:Steal EXP; 366:Plunder EXP |
...
| 0x2E | 4 | equipment_break | authoring-required | 160:Crush Armor; 161:Crush Helm; 162:Crush Weapon; 163:Crush Accessory |
...
| 0x58 | 1 | malboro_bundle | reverse-engineering | 329:Malboro Spores |
...
| 0x65 | 1 | ivc_custom | reverse-engineering | 45:Chant |
| 0x66 | 1 | ivc_custom | reverse-engineering | 184:Infernal Strike |
| 0x67 | 1 | ivc_custom | reverse-engineering | 219:Crushing Blow |
| 0x68 | 1 | ivc_custom | reverse-engineering | 220:Abyssal Blade |
| 0x69 | 1 | ivc_custom | reverse-engineering | 357:Unholy Sacrifice |
| 0x6A | 1 | ivc_custom | reverse-engineering | 358:Barrage |
| (blank) | 144 | command_meta, item_command, passive, reserved_or_unknown | data-authoring, formula-map-required, reverse-engineering | 368:Potion; 369:High Potion; 370:X-Potion; 371:Ether |

## Gate summary

- Wired now: `46` ability records.
- Formula/status/channel surface ready: `104` records.
- Ability/formula/data authoring still required: `194` records.
- Reverse engineering still required: `39` records.
- Metadata blocked only by design authoring: `92` records.
- Metadata blocked by technical investigation: `39` records.
- Metadata blocked by both mechanism and design: `50` records.
- High-risk special or externally dispatched records: `174`.

...
Row manifest: `work/1784009976-dcl-ability-classification-candidates.csv`.
...
- Reverse engineering still required: `25` records.
- Metadata blocked only by design authoring: `106` records.
- Metadata blocked by technical investigation: `25` records.
- Metadata blocked by both mechanism and design: `50` records.
- High-risk special or externally dispatched records: `160`.

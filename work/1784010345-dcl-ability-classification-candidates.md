...
Row manifest: `work/1784010345-dcl-ability-classification-candidates.csv`.
...
- Reverse engineering still required: `10` records.
- Metadata blocked only by design authoring: `121` records.
- Metadata blocked by technical investigation: `10` records.

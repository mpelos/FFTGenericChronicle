...
Row manifest: `work/1784010599-dcl-ability-classification-candidates.csv`.
...
- Ability/formula/data authoring still required: `200` records.
- Reverse engineering still required: `2` records.
- Metadata blocked only by design authoring: `126` records.
- Metadata blocked by technical investigation: `2` records.
- Metadata blocked by both mechanism and design: `53` records.

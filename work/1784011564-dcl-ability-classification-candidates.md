...
Row manifest: `work/1784011564-dcl-ability-classification-candidates.csv`.
...
- Metadata blocked only by design authoring: `158` records.
- Metadata blocked by technical investigation: `0` records.
- Metadata blocked by both mechanism and design: `22` records.

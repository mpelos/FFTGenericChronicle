...
Row manifest: `work/1784011703-dcl-ability-classification-candidates.csv`.
...
- Metadata blocked only by design authoring: `162` records.
- Metadata blocked by technical investigation: `0` records.
- Metadata blocked by both mechanism and design: `18` records.

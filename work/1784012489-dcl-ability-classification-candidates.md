...
Row manifest: `work/1784012489-dcl-ability-classification-candidates.csv`.
...
- Metadata blocked only by design authoring: `174` records.
- Metadata blocked by technical investigation: `0` records.
- Metadata blocked by both mechanism and design: `6` records.

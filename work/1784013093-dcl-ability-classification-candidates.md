...
Row manifest: `work/1784013093-dcl-ability-classification-candidates.csv`.
...
| Readiness | Abilities |
| --- | ---: |
| authoring-required | 84 |
| data-authoring | 128 |
| data-or-authoring-required | 4 |
| formula-map-required | 100 |
...
| 0x42 | 4 | recoil_physical_damage | surface-mapped | 351:Destroy; 352:Compress; 353:Dispose; 354:Pulverize |
...
| 0x5F | 1 | magic_damage | formula-map-required | 349:Nanoflare |
...
- Ability/formula/data authoring still required: `188` records.
- Reverse engineering still required: `0` records.
- Metadata blocked only by design authoring: `175` records.
- Metadata blocked by technical investigation: `0` records.
- Metadata blocked by both mechanism and design: `5` records.
- High-risk special or externally dispatched records: `156`.

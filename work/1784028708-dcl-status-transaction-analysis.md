...
- Output: `D:\Projects\FFTGenericChronicle\work\1784028708-dcl-status-transaction-analysis.md`
...
- Conservative ordinary single-result damage+rider subset: **22**.
- Status-only, cure, lifecycle, periodic, multihit, KO, or special carriers: **128**.
- Highest status ability id: **360**; all fit the 368-row override table.

The 22 ordinary single-result damage+rider abilities are:

`80, 82, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 155, 156, 158, 159, 202, 203, 204, 209, 211`.
...
For the conservative 22-action subset, `InflictStatus=0` can suppress the native rider while the HP result
...
before apply. The remaining 128 actions need their dedicated lifecycle/cardinality owner or

...
Row manifest: `work/1784075039-dcl-ability-classification-candidates.csv`.
...
- Metadata blocked only by design authoring: `180` records.
- Metadata blocked by technical investigation: `0` records.
- Metadata blocked by both mechanism and design: `0` records.

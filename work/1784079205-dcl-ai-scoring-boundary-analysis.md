...
- Output: `D:\Projects\FFTGenericChronicle\work\1784079205-dcl-ai-scoring-boundary-analysis.md`
...
- Sweep direct callers across executable sections: `0xD7FBD5F`, `0x10C8B0A8`.
- Calc direct callers across executable sections: `0x281F0D`, `0x307ED0`, `0xEF53F0F`.
- Expected VM-owned sweep and three calc origins: **FAIL**.

...
- `Josephine-Fervor-slot2-learned` signature `8111065000085003`: unit+`0xC3` `0` -> `2`
...
| `resume_en00_main.sav` | `Josephine-Fervor-slot2-learned` | `0x83CF8` | `0x83DBB` | `0` -> `2` |
...
| `resume_en00_fturn.sav` | `Josephine-Fervor-slot2-learned` | `0x83CF8` | `0x83DBB` | `0` -> `2` |
...
| `resume_en01_main.sav` | `Josephine-Fervor-slot2-learned` | `0x83CF8` | `0x83DBB` | `0` -> `2` |
...
| `resume_en01_fturn.sav` | `Josephine-Fervor-slot2-learned` | `0x83CF8` | `0x83DBB` | `0` -> `2` |
...
| `resume_enbtl_main.sav` | `Josephine-Fervor-slot2-learned` | `0x83CF8` | `0x83DBB` | `0` -> `2` |
...
- Fixture PNG: `1784429613-dcl-fear-josephine-fervor-slot2-arthur-999hp-fixture.png`
- Fixture SHA-256: `7AAF0DE6649D9586B71AA37B347900F21680D72D80541853A9211B53D5468068`

...
- `Josephine-Fervor-learned` signature `8111065000085003`: unit+`0x53` `0` -> `128`
...
| `resume_en00_main.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83D4B` | `0` -> `128` |
...
| `resume_en00_fturn.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83D4B` | `0` -> `128` |
...
| `resume_en01_main.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83D4B` | `0` -> `128` |
...
| `resume_en01_fturn.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83D4B` | `0` -> `128` |
...
| `resume_enbtl_main.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83D4B` | `0` -> `128` |
...
- Fixture PNG: `1784430521-dcl-fear-josephine-fervor-correct-arthur-999hp-fixture.png`
- Fixture SHA-256: `ABE5DDCB32F5D5982C75C273B23EEAD67A91BA2DC0F632EB90ADF87820C811FB`

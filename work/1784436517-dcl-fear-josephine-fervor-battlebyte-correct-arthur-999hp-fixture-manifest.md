...
- `Josephine-Fervor-learned` signature `8111065000085003`: unit+`0xC3` `0` -> `128`
...
| `resume_en00_main.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83DBB` | `0` -> `128` |
...
| `resume_en00_fturn.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83DBB` | `0` -> `128` |
...
| `resume_en01_main.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83DBB` | `0` -> `128` |
...
| `resume_en01_fturn.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83DBB` | `0` -> `128` |
...
| `resume_enbtl_main.sav` | `Josephine-Fervor-learned` | `0x83CF8` | `0x83DBB` | `0` -> `128` |
...
- Fixture PNG: `1784436517-dcl-fear-josephine-fervor-battlebyte-correct-arthur-999hp-fixture.png`
- Fixture SHA-256: `09795A0D12766DFFADC3CD90DAFA4402F6FFC43C2D45DA2B3FFC14FEACC2BF3F`

...
| `canonical-admission` | `0x281EF7` | PASS | `49 8B DD 8A 54 1D D8 80 FA FF 74 0F` | `0x281EF7` | complete outer-action TargetBatch before the first target calculation |
| `canonical-admission-order` | `0x281ED6` | PASS | `48 8D 05 23 E1 D7 FF 4C 8D B0 80 3E 85 01 4C 03 F6 49 8B CE` | `0x281ED6` | source unit+0x1A0 order record carrying selected X/map-level/Y |
| `canonical-post-apply` | `0x30AB4D` | PASS | `48 8B 5C 24 60 48 8B 6C 24 70` | `0x30AB4D` | post-target state-apply convergence for source effect and payment |
| `canonical-reaction-complete` | `0xD90CFA2` | PASS | `E8 A9 90 8F F2 48 8B 5C 24` | `0xD90CFA2` | terminal empty native queue scan after the outer action or a Reaction chain |
...
| `reaction-effect-complete` | `0x212C2E` | PASS | `66 44 01 70 0C` | `0x212C2E` | state-0x2C executed-reaction actor before cleanup |
